 ...
 * 
 */
@WebFault(name = "deliverError", targetNamespace = "http://ns.electronichealth.net.au/smd/svc/SealedImmediateMessageDelivery/2010")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: au.net.electronichealth.ns.simd.tls.v2010.DeliverErrorType
     */
